...
class $CatsTableTable extends CatsTable
  ...
  late final GeneratedColumn<String> breedDescription = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _breedTemperamentMeta =
      const VerificationMeta('breedTemperament');
  @override
  late final GeneratedColumn<String> breedTemperament = GeneratedColumn<String>(
      'breed_temperament', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  late final GeneratedColumn<String> breedOrigin = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _breedLifeSpanMeta =
      const VerificationMeta('breedLifeSpan');
  @override
  late final GeneratedColumn<String> breedLifeSpan = GeneratedColumn<String>(
      'breed_life_span', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  late final GeneratedColumn<int> adaptability = GeneratedColumn<int>(
      'adaptability', aliasedName, true,
      type: DriftSqlType.int, requiredDuringInsert: false);
  static const VerificationMeta _affectionLevelMeta =
      const VerificationMeta('affectionLevel');
  @override
  late final GeneratedColumn<int> affectionLevel = GeneratedColumn<int>(
      'affection_level', aliasedName, true,
      type: DriftSqlType.int, requiredDuringInsert: false);
  static const VerificationMeta _childFriendlyMeta =
      const VerificationMeta('childFriendly');
  @override
  late final GeneratedColumn<int> childFriendly = GeneratedColumn<int>(
      'child_friendly', aliasedName, true,
      type: DriftSqlType.int, requiredDuringInsert: false);
  static const VerificationMeta _dogFriendlyMeta =
      const VerificationMeta('dogFriendly');
  @override
  late final GeneratedColumn<int> dogFriendly = GeneratedColumn<int>(
      'dog_friendly', aliasedName, true,
      type: DriftSqlType.int, requiredDuringInsert: false);
  ...
  late final GeneratedColumn<int> healthIssues = GeneratedColumn<int>(
      'health_issues', aliasedName, true,
      type: DriftSqlType.int, requiredDuringInsert: false);
  ...
  late final GeneratedColumn<int> intelligence = GeneratedColumn<int>(
      'intelligence', aliasedName, true,
      type: DriftSqlType.int, requiredDuringInsert: false);
  static const VerificationMeta _socialNeedsMeta =
      const VerificationMeta('socialNeeds');
  @override
  late final GeneratedColumn<int> socialNeeds = GeneratedColumn<int>(
      'social_needs', aliasedName, true,
      type: DriftSqlType.int, requiredDuringInsert: false);
  static const VerificationMeta _strangerFriendlyMeta =
      const VerificationMeta('strangerFriendly');
  @override
  late final GeneratedColumn<int> strangerFriendly = GeneratedColumn<int>(
      'stranger_friendly', aliasedName, true,
      type: DriftSqlType.int, requiredDuringInsert: false);
  ...
  @override
  VerificationContext validateIntegrity(Insertable<CatsTableData> instance,
    ...
    if (data.containsKey('breed_temperament')) {
      context.handle(
          ...
          breedTemperament.isAcceptableOrUnknown(
              data['breed_temperament']!, _breedTemperamentMeta));
    }
    ...
    if (data.containsKey('breed_life_span')) {
      context.handle(
          ...
          breedLifeSpan.isAcceptableOrUnknown(
              data['breed_life_span']!, _breedLifeSpanMeta));
    }
    ...
    if (data.containsKey('health_issues')) {
      context.handle(
          ...
          healthIssues.isAcceptableOrUnknown(
              data['health_issues']!, _healthIssuesMeta));
    }
  ...
  CatsTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CatsTableData(
      ...
      breedTemperament: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}breed_temperament']),
      breedOrigin: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}breed_origin']),
      breedLifeSpan: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}breed_life_span']),
      adaptability: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}adaptability']),
      affectionLevel: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}affection_level']),
      childFriendly: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}child_friendly']),
      dogFriendly: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}dog_friendly']),
      energyLevel: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}energy_level']),
      healthIssues: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}health_issues']),
      intelligence: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}intelligence']),
      socialNeeds: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}social_needs']),
      strangerFriendly: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}stranger_friendly']),
...
class CatsTableData extends DataClass implements Insertable<CatsTableData> {
  ...
  CatsTableCompanion toCompanion(bool nullToAbsent) {
    return CatsTableCompanion(
      ...
      breedTemperament: breedTemperament == null && nullToAbsent
          ? const Value.absent()
          : Value(breedTemperament),
      breedOrigin: breedOrigin == null && nullToAbsent
          ? const Value.absent()
          : Value(breedOrigin),
      breedLifeSpan: breedLifeSpan == null && nullToAbsent
          ? const Value.absent()
          : Value(breedLifeSpan),
      adaptability: adaptability == null && nullToAbsent
          ? const Value.absent()
          : Value(adaptability),
      affectionLevel: affectionLevel == null && nullToAbsent
          ? const Value.absent()
          : Value(affectionLevel),
      childFriendly: childFriendly == null && nullToAbsent
          ? const Value.absent()
          : Value(childFriendly),
      dogFriendly: dogFriendly == null && nullToAbsent
          ? const Value.absent()
          : Value(dogFriendly),
      energyLevel: energyLevel == null && nullToAbsent
          ? const Value.absent()
          : Value(energyLevel),
      healthIssues: healthIssues == null && nullToAbsent
          ? const Value.absent()
          : Value(healthIssues),
      intelligence: intelligence == null && nullToAbsent
          ? const Value.absent()
          : Value(intelligence),
      socialNeeds: socialNeeds == null && nullToAbsent
          ? const Value.absent()
          : Value(socialNeeds),
      strangerFriendly: strangerFriendly == null && nullToAbsent
          ? const Value.absent()
          : Value(strangerFriendly),
      likedAt:
          likedAt == null && nullToAbsent ? const Value.absent() : Value(likedAt),
    );
  }

  factory CatsTableData.fromJson(Map<String, dynamic> json,
  ...
  CatsTableData copyWith(
      ...
      CatsTableData(
        ...
        breedDescription: breedDescription.present
            ...
            : this.breedDescription,
        breedTemperament: breedTemperament.present
        ...
        adaptability:
            adaptability.present ? adaptability.value : this.adaptability,
        affectionLevel:
        ...
        healthIssues:
            healthIssues.present ? healthIssues.value : this.healthIssues,
        intelligence:
            intelligence.present ? intelligence.value : this.intelligence,
        socialNeeds: socialNeeds.present ? socialNeeds.value : this.socialNeeds,
        strangerFriendly: strangerFriendly.present
